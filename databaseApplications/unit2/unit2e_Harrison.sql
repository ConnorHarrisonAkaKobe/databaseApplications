...
--HAVING filters the results as WHERE filters out loses

-- =====================================================================
-- VOCABULARY — your words, not the reference sheet's
-- =====================================================================

-- GROUP BY: Takes large amount of information and categories them


-- HAVING: After GROUP BY, it filters it like WHERE, but with GROUPS instead of ROWS
