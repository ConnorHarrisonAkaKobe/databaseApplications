...
-- 4 does raw points and 5 does one single decimal place
...
-- the filter at all?
SELECT COUNT(*) AS zero_gp
FROM player_season_stats
WHERE gp = 0;
-- 1, the filter is added for future reference in case the table changes
-- =====================================================================
-- VOCABULARY — your words, not the reference sheet's
-- =====================================================================

-- Calculated column: Computes a result for every single row in your table


-- Concatenation (||): Links 2 or more pieces of data in a chain
